            ...
            if (email.isNotEmpty() && password.isNotEmpty()) {
                ...
                lifecycleScope.launch {
                    ...
                    if (response.getString("status") == "success") {
                        ...
                        val session = SessionManager(this@UserLoginActivity)
                        ...
                        val intent = Intent(this@UserLoginActivity, UserDashboardActivity::class.java)
                        startActivity(intent)
                        finish()
                    } else {
                        Toast.makeText(this@UserLoginActivity, response.getString("message"), Toast.LENGTH_SHORT).show()
                        btnLogin.text = "Login"
